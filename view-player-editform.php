...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editPlayersModal<?php echo $game['game_id']; ?>">
...
<!-- Modal -->
<div class="modal fade" id="editPlayersModal<?php echo $game['game_id']; ?>" tabindex="-1" aria-labelledby="editPlayersModalLabel<?php echo $game['game_id']; ?>" aria-hidden="true">
