...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editGamesWithPlayersModal<?php echo $player['profile_id']; ?>">
...
<!-- Modal -->
<div class="modal fade" id="editGamesWithPlayersModal<?php echo $player['profile_id']; ?>" tabindex="-1" aria-labelledby="editGamesWithPlayersModalLabel<?php echo $player['profile_id']; ?>" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="editGamesWithPlayersModalLabel<?php echo $player['profile_id']; ?>">Edit Profile</h1>
